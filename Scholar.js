...
/*	-INFORMATION-
	Subject:	Class
	Effect:		This script adds a class called "Scholar" (v3.4) and the  subclasses for it: "Explorer Pursuit", "Inventor Pursuit", "Philosopher Pursuit", "Physician Pursuit", "Planar Sage Pursuit", and "Tactitian Pursuit" from the Scholar class PDF (v3.4).
				This is taken from the DMs Guild website (https://www.dmsguild.com/product/191839/The-Scholar)
				This class and subclasses are made by Kyle Grant.
	Code by:		Swordgeo
	Code version:	v1
	Date:			2024-010-27 (sheet v13.1.12)
	Please support the creator of this content (Kyle Grant) and download his material from the DMs Guild website: https://www.dmsguild.com/browse.php?author=Kyle%20Grant
*/

var iFileName = "Scholar v3.4 [Kyle Grant's work, transcribed by Swordgeo].js";
...
SourceList["KG:SC"] = {
	name : "Kyle Grant: the Scholar Class",
	abbreviation : "KG:SC",
